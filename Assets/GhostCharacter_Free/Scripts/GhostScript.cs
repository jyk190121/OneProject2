...
namespace Sample
{
        ...
        private Dictionary<int, bool> PlayerStatus = new Dictionary<int, bool>
    {
        ...
        private void MOVE()
        {
            ...
            {
                if (Input.GetKey(Key.UpArrow) && !Input.GetKey(Key.DownArrow) && !Input.GetKey(Key.LeftArrow) && !Input.GetKey(Key.RightArrow))
                {
                    MOVE_Velocity(new Vector3(0, 0, -Speed), new Vector3(0, 180, 0));
                }
                else if (Input.GetKey(Key.DownArrow) && !Input.GetKey(Key.UpArrow) && !Input.GetKey(Key.LeftArrow) && !Input.GetKey(Key.RightArrow))
                {
                    MOVE_Velocity(new Vector3(0, 0, Speed), new Vector3(0, 0, 0));
                }
                else if (Input.GetKey(Key.LeftArrow) && !Input.GetKey(Key.UpArrow) && !Input.GetKey(Key.DownArrow) && !Input.GetKey(Key.RightArrow))
                {
                    MOVE_Velocity(new Vector3(Speed, 0, 0), new Vector3(0, 90, 0));
                }
                else if (Input.GetKey(Key.RightArrow) && !Input.GetKey(Key.UpArrow) && !Input.GetKey(Key.DownArrow) && !Input.GetKey(Key.LeftArrow))
                {
        ...
        private void KEY_UP()
        {
            ...
            {
                if (!Input.GetKey(Key.DownArrow) && !Input.GetKey(Key.LeftArrow) && !Input.GetKey(Key.RightArrow))
                {
                    Anim.CrossFade(IdleState, 0.1f, 0, 0);
                }
            }
            else if (Input.GetKeyUp(Key.DownArrow))
            {
                if (!Input.GetKey(Key.UpArrow) && !Input.GetKey(Key.LeftArrow) && !Input.GetKey(Key.RightArrow))
                {
                    Anim.CrossFade(IdleState, 0.1f, 0, 0);
                }
            }
            else if (Input.GetKeyUp(Key.LeftArrow))
            {
                if (!Input.GetKey(Key.UpArrow) && !Input.GetKey(Key.DownArrow) && !Input.GetKey(Key.RightArrow))
                {
                    Anim.CrossFade(IdleState, 0.1f, 0, 0);
                }
            }
            else if (Input.GetKeyUp(Key.RightArrow))
            {
                if (!Input.GetKey(Key.UpArrow) && !Input.GetKey(Key.DownArrow) && !Input.GetKey(Key.LeftArrow))
                {
                    Anim.CrossFade(IdleState, 0.1f, 0, 0);
                }
            }
